...
export const Account = () => {
  ...
  const login2=useSelector(state=>state.bookslist.login)
  if(login2[0]){
     console.log('runing')
     return<>
     <div className="loged">
    ...
    <p className="name-client"> Amil Seferov
        <span>amilseferov@gmail.com
        </span>
    </p>
    ...
    return (
      <>
        ...
        <form className="form">
          ...
          <button onClick={(e)=>{
            e.preventDefault()
            console.log(state.pasword,state)
            if(state.email==='amilseferov@gmail.com'&&state.pasword==='1234'){
            dispatch(login([{...state}]))
            }
          }} className="form-btn">Log in</button>
        </form>
